...
// Custom inline SVG mascot. Stewart's PPC.io purple, treated as a beveled
// 3D fedora sitting on top of binoculars — the agent's signature.
function SpyMascot() {
  return (
    <svg
      width="280"
    ...
    >
      ...
      {/* Ground glow */}
      <ellipse cx="140" cy="220" rx="92" ry="12" fill="url(#ground)" />

      {/* Hat: brim */}
      <ellipse cx="140" cy="88" rx="118" ry="20" fill="url(#hat-brim)" />
      ...
      />
      {/* Hat: band */}
      <ellipse cx="140" cy="82" rx="118" ry="8" fill="url(#hat-band)" />
      {/* Hat: brim shadow underside */}
      <path
        d="M22 88
      ...
      <g>
        ...
        <circle cx="95"  cy="154" r="28" fill="url(#binoc-lens)" />
        <circle cx="95"  cy="154" r="14" fill="url(#binoc-pupil)" />
        <circle cx="89"  cy="148" r="4"  fill="rgba(255,255,255,0.55)" />
        {/* Right lens ring */}
        <circle cx="185" cy="154" r="32" fill="#1C1340" />
        <circle cx="185" cy="154" r="28" fill="url(#binoc-lens)" />
        <circle cx="185" cy="154" r="14" fill="url(#binoc-pupil)" />
